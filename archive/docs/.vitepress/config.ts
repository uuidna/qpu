...
export default defineConfig({
  ...
  description: `Quantum processing unit as three readings. Seat ${seat.seat}. ${h.veFaces} faces and particle 1. Captain coins ${pack.wallet}.`,
  cleanUrls: true,
  lastUpdated: true,
  ...
  head: [
    ...
    ['meta', { name: 'apple-mobile-web-app-title', content: 'QPU' }],
  ],
  markdown: {
